...
<head>
  ...
  <title>Login | Hens Products Delivery</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-6 d-none d-lg-block bg-login-image"><a href="index.php"><img src="photos/layout/ONLINE2.jpg" class="logo-img" style="width: 400px; margin: 40px"></a></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Back To Login!</h1>
