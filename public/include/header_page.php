...
<div class="row">
                ...
                <form class="search" method="post">
                    ...
                    <input type="text" class="form-control" placeholder="Search Item . . ." onfocus = " this.value=' '" onblur=" this.value=' Search Item . . .'">
...
<?php include("public/include/shopping_cart.php"); ?>
                    ...
                    <div class="col-md-6">
                        <div class="btn-group pull-right" style="z-index: 2">
                            <a href="public/include/login.php" class=" btn btn-primary btn-md "><i class="fa fa-key"></i> Login</a>
